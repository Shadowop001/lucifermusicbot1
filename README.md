...
- Some Of The Mandatory Vars Are :-
   - `API_ID` :  Give API_ID of your Alternate Telegram Account. also from here @APIInfoBot
   - `API_HASH` :  Give API_HASH of your Alternate Telegram Account. also from here @APIInfoBot
